...
<body style="background-color:white" onload="totalprice()" >
  ...
  <header id="header"><!--header-->
    <div class="header_top" style="background: linear-gradient(to bottom, #0f166e 0%, #0f166e 100%); !important;"><!--header_top-->
      <div class="container">
        <div class="row">
          <div class="col-sm-6">
            <div class="contactinfo">
              <ul class="nav nav-pills" >
                <li><a href="#"><i class="fa fa-phone"></i> +6012850-0317</a></li>
                <li><a href="#"><i class="fa fa-envelope"></i> danielbelteshazzar8@gmail.com</a></li>
              </ul>
            </div>
          </div>
          <div class="col-sm-6">
        ...
        <div class="row">
          <div class="col-md-4 clearfix">
            <div class="logo pull-left">
              <a href="<?php echo web_root?>"><img src="images/home/logo_size.jpg" alt="" /></a>
            </div> 
          </div>
        ...
        <div class="row">
          <div class="col-sm-2">
            <div class="companyinfo">
              ...
              <p>Close, Easy only at the tip of your fingertip!</p>
            </div>
          </div>
          <div class="col-sm-7">
    ...
    <div class="footer-bottom">
      <div class="container">
        <div class="row">
          <p class="pull-left">Go to my <span><a href="https://www.linkedin.com/in/mohammad-firdaus-hamid-4bb5b321a/"><i class="fas fa-linkedin-in    ">Linkedin</i></a></span></p>
          <p class="pull-right">Designed by <span><a target="_blank" href="">7 Sky Projects</a></span></p>
        </div>
      </div>
    </div>
